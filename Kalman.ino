...
double Q_angulo2 = 0.001;
double Gyro_Q_angulo2 = 0.003;
double R_angulo2 = 0.3;
...
double Kalman_2(double angulo2, double taxa2, double tempo2){
...
double AtualizaKalman(){
  double kalman_result = Kalman(Acc_anguloATAN(), Giro_gyr, looptime);
  double kalman_result2 = Kalman2(kalman_result, Giro_gyr, looptime);
}
